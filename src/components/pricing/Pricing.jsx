        ...
        <div className="pricing__container container grid">
            <div className="pricing__item card card-one">
                ...
                <p className="pricing__description">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni commodi sequi incidunt numquam pariatur, necessitatibus ratione sit, quae earum ipsum ut voluptates aut, odit temporibus. Maiores hic excepturi rerum sapiente?
                </p>
            ...
            <div className="pricing__item-wrapper">
                <span className="pricing__label text0cs">Popular</span>
                <div className="pricing__item card card-one">
